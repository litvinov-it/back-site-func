...
export default function Home() {
  ...
  useScrollHistory();
  usePopState((event) => {
    const historyArray = JSON.parse(sessionStorage.getItem('scrollHistory')) || [];
  ...
  return (
    <main className="h-[2200px] flex flex-col justify-center items-center bg-black">
      ...
      <Link className="p-4 bg-slate-600 text-white fixed bottom-2 left-1/2 cursor-pointer" href='test'>GO test PAGE</Link>
